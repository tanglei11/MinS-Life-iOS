...
//        bar.backgroundColor = [UIColor clearColor];
        ...
        [self addSubview:bar];
        self.bottomBar = bar;
        BHBCenterView * centerView = [[BHBCenterView alloc]initWithFrame:CGRectMake(0, self.frame.size.height * 0.45, self.frame.size.width, self.frame.size.height * 0.4)];
...
//        BHBItem * item = [[BHBItem alloc]initWithTitle:titles[i] Icon:imageArray[i] iconColor:@""];
