...
- (void)layoutBtnsWith:(NSArray *)items isMore:(BOOL)isMore{
    ...
    for (int i = 0; i < items.count; i ++) {
        ...
        [btn setImage:[ToolClass imageWithIcon:[NSString changeISO88591StringToUnicodeString:item.icon] inFont:ICONFONT size:60 color:[UIColor colorFromHex:item.iconColor]] forState:UIControlStateNormal];
